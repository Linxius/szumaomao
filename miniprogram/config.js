...
module.exports = {
  ...
  app_version: "v1.1.1",
  // laf后台服务地址
  laf_url: 'https://ci0tkz.laf.run',
  // laf后台服务地址（微信开发工具中），一般和上面laf_url一致就好
  laf_dev_url: 'https://ci0tkz.laf.run',
  ...
  text: {
    ...
    reward: {
      ...
      ad_fail_tip: "没播完喵...",
      reward_tip_title: "打赏捐助",
      reward_tip: "所有收入将用于校园流浪动物，所有收支将会在公众号以推文形式公示，感谢您对流浪动物的帮助与支持！",
      reward_count_tip: "欢迎订阅公众号-深大动物保护平台",//* 每月统计一次，在公众号公示，多谢晒（鞠躬）",
      reward_title: "爱心捐款",
    },
    ...
    feedback: {
      ...
      contract_tip: "有关猫猫信息添加、小程序的建议、照片维权、猫猫领养咨询等事项，请关注深大动物保护平台公众号后留言",
    },
    // 开发团队页，pages/info/devTeam/devTeam
    dev_team: {
      share_tip: "小程序维护团队",
      team: "深大动保协会、小林、咩咩，欢迎感兴趣的同学成为小程序维护志愿者。",
    },
